 ...
 */
class service_manager extends CModule
{
    /**
     * Индификатор модуля
     * @var string
     */
    public $MODULE_ID = 'service.manager';

    /**
     * ylab_monitoring constructor.
     */
    public function __construct()
    {
        ...
        $this->MODULE_NAME = Loc::getMessage('YLAB_SERVICE_MANAGER_MODULE_NAME');
        $this->MODULE_DESCRIPTION = Loc::getMessage('YLAB_SERVICE_MANAGER_MODULE_DESCRIPTION');
    }
    ...
    {
        deleteDirFiles($_SERVER['DOCUMENT_ROOT'] . '/local/modules/service.manager/install/admin',
